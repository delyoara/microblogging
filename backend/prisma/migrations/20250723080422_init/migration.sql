...
-- CreateIndex
CREATE UNIQUE INDEX "Category_name_themeId_key" ON "Category"("name", "themeId");
...
-- AddForeignKey
ALTER TABLE "Category" ADD CONSTRAINT "Category_themeId_fkey" FOREIGN KEY ("themeId") REFERENCES "Theme"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
